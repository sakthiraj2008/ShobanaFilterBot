...
DEFAULT_AUTH_CHANNELS = [int(x) for x in environ.get("AUTH_CHANNEL", "-1002450932371").split() if x.lstrip('-').isdigit()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "ascfilter")
